...
class CourseMaterial:
    ...
    def main(self):
        ...
        with t1:
            ...
            course1 = st.selectbox("Modules",self.course_names, index=st.session_state.course_index, key = "video_nav", on_change=video_handle_change)
        ...
        with t2:
            ...
            course2 = st.selectbox("Modules",self.course_names, index=st.session_state.course_index, key = "slides_nav", on_change=slide_handle_change)    
